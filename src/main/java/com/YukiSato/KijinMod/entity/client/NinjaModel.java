package com.YukiSato.KijinMod.entity.client;// Made with Blockbench 4.9.3
...
public class NinjaModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public NinjaModel(ModelPart root) {
